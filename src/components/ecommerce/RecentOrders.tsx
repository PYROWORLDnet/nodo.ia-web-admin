        ...
        <Table>
          ...
          <TableHeader className="border-gray-100 dark:border-gray-800 border-y">
            <TableRow>
              <TableCell
                isHeader
                className="py-3 font-medium text-gray-600 dark:text-gray-300 text-start text-theme-xs"
              >
                Products
              </TableCell>
              <TableCell
              ...
              <TableRow key={product.id} className="">
                <TableCell className="py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-black dark:text-white text-theme-sm">
                        {product.name}
                      </p>
                      <span className="text-gray-600 dark:text-gray-300 text-theme-xs">
                        {product.variants}
                      </span>
                    </div>
                  </div>
                </TableCell>
                <TableCell className="py-3 text-black dark:text-white text-theme-sm">
                  {product.price}
                </TableCell>
                <TableCell className="py-3 text-black dark:text-white text-theme-sm">
                  {product.category}
